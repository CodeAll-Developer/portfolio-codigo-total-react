...
export const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_220xy8a', 'template_u2ozxel', form.current, 'jJHihkGGxX2hl0n6v')
            .then((result) => {
                Swal.fire({
                    title: 'Enviado!',
                ...
                <div className="contact__content">
                    ...
                    <form ref={form} onSubmit={sendEmail} action="" className="contact__form">
                        ...
                        <div className="contact__form-div contact__form-area">
                            ...
                            <textarea className="contact__form-input " name="project" cols="30" rows="10" placeholder="Insert description of your project">
