                ...
                <div className="qualification__sections">
                    <div   className={toggleState === 2 ? "qualification__content qualification__content-active": "qualification__content"}>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__tittle">FullStack developer Spring and Angular</h3>
                                <span className="qualification__subtitle">Express Game Controller</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calendar-alt"></i>
                                    2022
                                </div>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__tittle">Developer Full Stack PHP</h3>
                                <span className="qualification__subtitle">GDLWEBCAMP</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calendar-alt"></i>
                                    2021
                                </div>
                        ...
                        <div className="qualification__data">
                            {/*text*/}
                            <div>
                                <h3 className="qualification__tittle">Developer Full Stack Node</h3>
                                <span className="qualification__subtitle">Shopex</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calendar-alt"></i>
                                    2022
                                </div>
                        ...
                        <div className="qualification__data">
                            ...
                            {/*text*/}
                            <div>
                                <h3 className="qualification__tittle">Developer Full Stack MEAN</h3>
                                <span className="qualification__subtitle">Bienes Raices</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calendar-alt"></i>
                                    2022
                                </div>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__tittle">Developer Backend Spring Boot</h3>
                                <span className="qualification__subtitle">Express Game</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calendar-alt"></i>
                                    2021-2022
                                </div>
